      ...
      <div className="mx-auto max-w-[1140px]">
        <Reveal y={30}>
          <Link
            ...
            className="af-card group relative grid grid-cols-1 overflow-hidden rounded-[26px] border border-black/[0.08] bg-white shadow-[0_24px_60px_rgba(0,0,0,.07)] md:grid-cols-[1.05fr_0.95fr]"
          >
